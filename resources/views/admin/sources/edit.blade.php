...
@section('content')
    ...
    <div class="col-md-7 col-lg-8">
        ...
        <form class="needs-validation" novalidate method="post" action="{{ route('admin.sources.update', ['source' => $source]) }}">
            @csrf
            @method('put')
            <div class="row g-3">
                <div class="col-6">
                    <label for="name" class="form-label">User's name</label>
                    <input type="text" class="form-control" name="name" id="name" value="{{ $source->name }}" required>
                ...
                <div class="col-6">
                    ...
                    <input type="text" class="form-control" name="email" id="email" value="{{ $source->email }}" required>
                    <div class="invalid-feedback">
                        Email is required
                    </div>
                </div>
                <div class="col-12">
                    ...
                    <input type="url" class="form-control" name="url" id="url" value="{{ $source->url }}" required>
                    <div class="invalid-feedback">
                        Email is required
                    </div>
                </div>
